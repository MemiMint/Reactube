...
const PlayLists: NextPage = (): JSX.Element => {
  ...
  return (
    <>
      <Navbar />
      <ChannelLayout>
        <PlayList title="Playlist #1" videos={fakeData} />
        <PlayList title="Playlist #2" videos={fakeData} />
        <PlayList title="Playlist #3" videos={fakeData} />
      </ChannelLayout>
    </>
  );
};
